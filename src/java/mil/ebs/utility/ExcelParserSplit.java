...
public abstract class ExcelParserSplit<T1, T2> {
    ...
    public ExcelParserSplit() {
        // list of data records
        list1 = new ArrayList<T1>(1);
        list2 = new ArrayList<T2>(1);
    ...
    public void addList1(final T1 pT) {
        list1.add(pT);
    }

    public void addList2(final T2 pT) {
        list2.add(pT);
    }
    ...
    abstract public void parse(final Workbook pWorkbook, final Date pFileAsOfDate, final Account pAccount);
