	...
	<body>
		...
		<div id="create-newsItem" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:newsItemInstance, action:'save']" >
                <g:hiddenField name="dateCreated" id="dateCreated" value="${newsItemInstance?.dateCreated}"/>
                <g:hiddenField name="lastUpdated" id="lastUpdated" value="${newsItemInstance?.lastUpdated}"/>
				<fieldset class="form">
