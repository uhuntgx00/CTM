    ...
    <g:if test="${ccd?.totalCost > 0}">
        window.onload = function () {
            var r = Raphael("raphael"),
                pie1 = r.piechart(600, 160, 120, ${ccd?.costList}, {
            ...
            r.text(700, 10, 'Total Cost by Type (<g:formatNumber number="${ccd?.totalCost}" type="currency" currencyCode="USD" maxFractionDigits="2" />)').attr({ font: "20px sans-serif" });
