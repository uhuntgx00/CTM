...
<html>
	...
	<body>
		...
		<div id="edit-attendee" class="content scaffold-edit" role="main">
            ...
            <g:form url="[resource:attendeeInstance, action:'updateAttendeeWizard']" method="PUT" >
				<fieldset class="form">
					<g:render template="form"/>
				</fieldset>
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="conferenceUpdateWizard" value="${message(code: 'default.button.update.label', default: 'Update')}" />
				</fieldset>
			</g:form>
		</div>
