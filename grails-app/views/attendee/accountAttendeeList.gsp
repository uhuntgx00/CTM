...
<html>
	<head>
		...
		<title>Attendee List (Account)</title>
	</head>
	<body>
		...
		<div id="list-attendee" class="content scaffold-list" role="main">
			<h1>Attendee List (Account)&nbsp;[${attendeeInstanceCount}]</h1>
			...
			<table>
			    <thead>
					<tr>
						<th><g:message code="attendee.account.label" default="Account" /></th>
						...
						<th><g:message code="attendee.supervisor.label" default="Supervisor" /></th>
            ...
            <g:if test="${attendeeInstanceCount}">
