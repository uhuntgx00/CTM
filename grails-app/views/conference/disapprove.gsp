...
<html>
	<head>
		...
		<title>Disapproval Notice</title>
	...
	<body>
		...
		<div id="edit-conference" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:conferenceInstance, action:'disapprove']" method="PUT" >
				<fieldset class="form">
					<g:render template="formDisapprove"/>
				</fieldset>
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="disapprove" value="${message(code: 'default.button.update.label', default: 'Update')}" />
				</fieldset>
			</g:form>
		</div>
