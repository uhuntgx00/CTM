				...
				<g:each in="${conferenceInstanceList}" status="i" var="conferenceInstance">
                    <g:if test="${!conferenceInstance?.hide || !(conferenceInstance?.displayAfter > new Date())}">
                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                            ...
                            <td>|</td>
                            <td style="color:#000077"><b><g:formatNumber number="${conferenceInstance?.constrainedTotal()}" type="currency" currencyCode="USD" maxFractionDigits="2" /></b></td>
                            <td style="color:#000077">
                                <g:if test="${conferenceInstance?.constrainedTotalByFunding()?.get("US Air Force")}">
                                    <g:formatNumber number="${conferenceInstance?.constrainedTotalByFunding()?.get("US Air Force")}" type="currency" currencyCode="USD" maxFractionDigits="2" />
                                </g:if>
                                <g:else>
                                    $0.00
                                </g:else>
                            ...
                            <td style="color:#000077">
                                <g:if test="${conferenceInstance?.constrainedTotalByFunding()?.get("Other US Govt")}">
                                    <g:formatNumber number="${conferenceInstance?.constrainedTotalByFunding()?.get("Other US Govt")}" type="currency" currencyCode="USD" maxFractionDigits="2" />
                                </g:if>
                                <g:else>
                                    $0.00
                                </g:else>
                            ...
                            <td style="color:#000077">
                                <g:if test="${conferenceInstance?.constrainedTotalByFunding()?.get("Non-Federal Entity")}">
                                    <g:formatNumber number="${conferenceInstance?.constrainedTotalByFunding()?.get("Non-Federal Entity")}" type="currency" currencyCode="USD" maxFractionDigits="2" />
                                </g:if>
                                <g:else>
                                    $0.00
                                </g:else>
