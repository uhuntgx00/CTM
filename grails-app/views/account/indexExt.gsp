            ...
            <table>
                <thead>
                    <tr>
                        ...
                        %{--<g:sortableColumn property="fsOrganization" title="${message(code: 'account.fsOrg.label', default: 'fsOrganization')}"/>--}%
                ...
                <tbody>
                    <g:form method="post" action="${indexEvent}">
                        ...
                        <tr class="odd">
                            <td>
                                <g:textField name="searchAccount" value="${searchAccount}" size="50" />&nbsp;
                                <g:actionSubmitImage value="filter" action="${indexEvent}" src="${resource(dir: 'images/icons', file:'search_512.png')}" align="top" width="18" height="18" title="Search for Account" alt="Search for Account"/>
                                <g:actionSubmitImage value="assign" action="assignOrg" src="${resource(dir: 'images/icons', file:'send-group_512.png')}" align="top" width="18" height="18" title="Assign all to ${searchAccount}" alt="Assign all to ${searchAccount}"/>
                            </td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                    ...
                    <g:each in="${accountInstanceList}" status="i" var="accountInstance">
                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                            ...
                            %{--<td class="no_underline">${accountInstance?.fsOrganization}</td>--}%
