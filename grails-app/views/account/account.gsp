    ...
    <table>
        <thead>
            <tr>
                ...
                <g:sortableColumn property="lastLoginDate" title="${message(code: 'account.lastLogin.label', default: 'Last Logon')}"/>
                <g:sortableColumn property="loginCount" title="${message(code: 'account.count.label', default: 'Count')}"/>
                <g:sortableColumn property="accountExpired" title="${message(code: 'account.accountExpired.label', default: 'Expired')}"/>
                <g:sortableColumn property="lastExpirationDate" title="${message(code: 'account.lastExpired.label', default: 'Last Expired')}"/>
        ...
        <tbody>
            ...
            <g:each in="${accountInstanceList}" status="i" var="accountInstance">
                <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                    ...
                    <td><g:formatDate date="${accountInstance?.lastLoginDate}" type="date" style="Long"/></td>
                    <td>${accountInstance?.loginCount}</td>
                    <td>
                    ...
                    <td><g:formatDate date="${accountInstance?.lastExpirationDate}" type="date" style="Long"/></td>
                    <td>
