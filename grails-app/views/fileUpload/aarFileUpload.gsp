...
<html>
    ...
    <body>
        ...
        <div id="upload" class="content scaffold-list" role="main">
            <h1>
                AAR File Upload for <b>${conference}</b>
            </h1>
            <g:if test="${flash.message}">
                <div class="message" role="status">${flash.message}</div>
            </g:if>

            <g:form controller="fileUpload" method="post" action="saveAAR" enctype="multipart/form-data">
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td>&nbsp;</td>
                                <td align="right"><b>(AAR) After Action Report (?)</b></td>
